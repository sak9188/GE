...
GE::IO& GE::IO::operator<<(const char* s)
{
...
GE::IO& GE::IO::operator<<(const std::string& s)
{
	//if (this->bHasRedirectToFile)
	//{
	//	std::cout << s;
...
GE::IO& GE::IO::operator<<(GE::Int64 i64)
{
	std::cout << i64;
	this->outBuf << i64;
	return *this;
...
GE::IO& GE::IO::operator<<(GE::Uint64 ui64)
{
	std::cout << ui64;
	this->outBuf << ui64;
	return *this;
...
GE::IO& GE::IO::operator<<(GE::Int32 i32)
{
	std::cout << i32;
	this->outBuf << i32;
	return *this;
...
GE::IO& GE::IO::operator<<(GE::Uint32 ui32)
{
	std::cout << ui32;
	this->outBuf << ui32;
	return *this;
...
GE::IO& GE::IO::operator<<(GE::Int8 i8)
{
...
GE::IO& GE::IO::operator<<(GE::Uint8 ui8)
{
...
void GE::IO::ShowTime(bool isShow)
{
	showTime = isShow;
}

std::string GE::IO::GetOutString()
{
